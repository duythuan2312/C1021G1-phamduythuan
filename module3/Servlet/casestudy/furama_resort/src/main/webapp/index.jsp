...
<html>
  ...
  <nav style="background:#0c5460 ">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <a class="nav-item nav-link" id="nav-customer-tab" href="/customer" style="color: white">Customer</a>
      <a class="nav-item nav-link" id="nav-service-tab" href="/service" style="color: white">Service</a>
      <a class="nav-item nav-link" id="nav-contract-tab" href="/contract" style="color: white">Contract</a>
    </div>
  </nav>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img height="60%" class="d-block w-100" src="https://cdn1.ivivu.com/iVivu/2019/11/28/13/furama-resort-da-nang-1-cr-800x450.jpg" alt="First slide">
        </div>
        <div class="carousel-item">
          <img height="60%" class="d-block w-100" src="https://daiduongviet.vn/wp-content/uploads/2019/05/furama-resort-da-nang-1.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img height="60%" class="d-block w-100" src="https://chefjob.vn/wp-content/uploads/2020/07/Furama_Resort-su-lua-chon-tuyet-voi.jpg" alt="Third slide">
        </div>
        <div class="carousel-item" >
          <img height="60%" class="d-block w-100" src="http://hotlinedatphong.com/wp-content/uploads/2019/08/bakhan-village-resort-hoa-binh-restaurant-1024x417.gif" alt="Third slide">
        </div>
      </div>
